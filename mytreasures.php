	...
	function showmyTreasuresContent($myTreasuredID = false, $myTreasuredSort = false, $myTreasureType = false) {
	  ...
	  get_currentuserinfo();
		...
		if(!$myTreasuredSort && preg_match("/^([0-9]+)$/",$myTreasuredID)) {
			...
			if($myTreasures_options[option20] == 'no') 		{ $content .= "<tr><td align=\"left\" valign=\"top\" style=\"font-weight: bold;\" nowrap>Links</td><td align=\"left\" valign=\"top\"><a type=amzn search=\"".str_replace("\"","",$result01[field01])."\">Amazon.de</a><SCRIPT charset=\"utf-8\" type=\"text/javascript\" src=\"http://ws.amazon.de/widgets/q?ServiceVersion=20070822&MarketPlace=DE&ID=V20070822/DE/crazyivende-21/8005/fa48ef75-2c02-4e40-a251-4ac49ca85046\"></SCRIPT><NOSCRIPT><A HREF=\"http://ws.amazon.de/widgets/q?ServiceVersion=20070822&MarketPlace=DE&ID=V20070822%2FDE%2Fcrazyivende-21%2F8005%2Ffa48ef75-2c02-4e40-a251-4ac49ca85046&Operation=NoScript\">Amazon.de Widgets</A></NOSCRIPT></td></tr>"; }
