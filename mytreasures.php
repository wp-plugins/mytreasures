...
*/
	...
	$myTreasuresPluginVersion = "1.0.11";
	  ...
	  get_currentuserinfo();
		...
		if($myTreasuredSort == "covers") {
			...
			while($result01 = mysql_fetch_array($query01)) {
				...
				if($result01[image] && file_exists(ABSPATH."wp-content/mytreasures/".$result01[image])) { $imagelink = get_bloginfo('wpurl')."/wp-content/mytreasures/".$result01[image]; } else { $imagelink = get_bloginfo('wpurl')."/wp-content/plugins/mytreasures/images/default.jpg"; }
				if($myTreasures_options[option30] == 'yes' && file_exists(ABSPATH."wp-content/mytreasures/big_".$result01[image])) { $imagebig = "<center><img src=\'".get_bloginfo('wpurl')."/wp-content/mytreasures/big_".$result01[image]."\'></center><br />"; } else { $imagebig = false; }
		...
		if(!$myTreasuredSort && preg_match("/^([0-9]+)$/",$myTreasuredID)) {
			...
			if($result01[image] && file_exists(ABSPATH."wp-content/mytreasures/".$result01[image])) { $imagelink = get_bloginfo('wpurl')."/wp-content/mytreasures/".$result01[image]; } else { $imagelink = get_bloginfo('wpurl')."/wp-content/plugins/mytreasures/images/default.jpg"; }
			if($myTreasures_options[option30] == 'yes' && file_exists(ABSPATH."wp-content/mytreasures/big_".$result01[image])) { $imagelinkbig = get_bloginfo('wpurl')."/wp-content/mytreasures/big_".$result01[image]; $imagebig = "<center><img src=\'".get_bloginfo('wpurl')."/wp-content/mytreasures/big_".$result01[image]."\'></center><br />"; } else { $imagelinkbig = false; }
