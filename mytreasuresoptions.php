...
<br /><input name="option39" type="radio" value="no" <?php if($result01['option39'] == '' || $result01['option31'] == 'no') { echo "checked=\"checked\""; } ?>/> <?php echo __("Activate rating system",$myTreasuresTextdomain); ?>
